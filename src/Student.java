...
public class Student implements Interface{
    ...
    public void mainApp(){
        try {
            ...
            getStdID(stName);
            viewModulesAlongwithInstructor(courseId, stdLevel);
    ...
    private void viewModulesAlongwithInstructor(String courseId, int stdLevel) {
        try {
            ResultSet result = db.getModulesAlongwithInstructor();
            String content = "";
            while (result.next()) {
